...
- Mapped specs: 40
- Declared test blocks: 145
- Weighted coverage points: 114.4
...
| --- | --- | --- | --- |
| audio-device | 2 specs / 25 tests / 19.0 pts | 1 specs / 1 tests / 0.3 pts | - |
| capture-ocr | 2 specs / 12 tests / 4.8 pts | 2 specs / 3 tests / 1.2 pts | 1 specs / 2 tests / 0.8 pts |
| chat-ai | 6 specs / 6 tests / 3.4 pts | 8 specs / 9 tests / 4.3 pts | 6 specs / 6 tests / 3.4 pts |
| local-api | 10 specs / 75 tests / 63.7 pts | 9 specs / 51 tests / 45.1 pts | 8 specs / 50 tests / 44.7 pts |
...
| real-ui-e2e | 16 specs / 66 tests / 54.7 pts | 17 specs / 54 tests / 44.6 pts | 14 specs / 48 tests / 42.7 pts |
...
| windows-core-recording.spec.ts | windows | capture-ocr, local-api, audio-device, real-ui-e2e | capture-ocr, local-api-auth, local-api-search, audio-device-health, timeline | high | conditional | mixed | 10 | Windows recording-enabled lane; hosted runners can skip frame-dependent OCR assertions. |
