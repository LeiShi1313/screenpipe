...
export type Settings = SettingsStore & {
	 ...
	 * window) has been completed or skipped. Stored here — not in a Tauri
	 * command/state — so it persists in the normal settings store with no
	 * bindings regen. Gating lives in app/home/page.tsx. Default off. */
